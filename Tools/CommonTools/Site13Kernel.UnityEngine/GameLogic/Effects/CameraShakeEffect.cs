...
namespace Site13Kernel.GameLogic.Effects
{
    public class CameraShakeEffect : MonoBehaviour
    {
        ...
        public void SetShake(float Intensity = 0.1f, bool willDiminish = true, float DiminishIntensity = 0.5f, bool RotationMode = false, float RotationShakeSpeed=25f)
        {
        ...
        {
            SetShake(Intensity, willDiminish, DiminishIntensity, false);
        }
    }
