...
{
    public class ForgeMapButton : Selectable, IPointerClickHandler, IEventSystemHandler, ISubmitHandler, IVisualElement
    {
        ...
        [HideInInspector]
        public ForgeMapButtonGroup CampaignParent;
        [HideInInspector]
        public ForgeUIMenu menu;
        ...
        protected ForgeMapButton()
        {
        }
        public ForgeMap AssociatedMapDefinition;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetMap(ForgeMap Definition)
        {
            AssociatedMapDefinition = Definition;
            MissionName.text = Definition.DisplayName;
            foreach (var item in menu.BaseMapCoverMapping)
            {
                if (item.Key == Definition.BaseMapID)
                {
        ...
        public void Init(ForgeMapButtonGroup parent, MissionDefinition definition)
        {
    ...
    [Serializable]
    public class ForgeMapButtonGroup
    {
        public List<ForgeMapButton> Children = new List<ForgeMapButton>();
        public ForgeMapButton Selected;
